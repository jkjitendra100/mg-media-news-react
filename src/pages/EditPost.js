...
export default function EditPost() {
  ...
  const [subCategory, setSubCategory] = useState("no");
  ...
  useEffect(() => {
    ...
    setSubCategory(postDetails?.subCategory);
    setTitle(postDetails?.title);
    setDesc(postDetails?.desc);
    setPostType(postDetails?.postType);
    postType === "videoPost" && setVideoUrl(postDetails?.videoUrl);
    postType === "imagePost" && setImage(postDetails?.imageUrl);
    setTagList(postDetails?.tagList);
          ...
          uploadTask.on(
            ...
            async () => {
              getDownloadURL(uploadTask.snapshot.ref).then(
                async (downloadURL) => {
                  const updatePost = doc(db, "mgNewsPost", postDetails?.id);
  ...
  return (
    <div className="">
      <div className="">
        <div className="pt-0 bg-white shadow-md shadow-gray-500 rounded-md">
          ...
          <div className="p-4 text-left">
            <div className="grid grid-cols-2">
              ...
              <div className="mx-2">
                <h2>Please select Sub-Category</h2>
                <select
                  className="p-2 mb-4 w-full border border-slate-400 rounded-md"
                  value={subCategory}
