...
export const AppAuth = () => {
  ...
  return (
		<div className={`min-h-screen relative`}>
			<div className="h-12 md:h-20 py-2 z-50 bg-white sticky top-0 flex border-b-4 border-[#ff1717] justify-between text-xl text-gray-700 shadow-sm shadow-slate-400 duration:1000">
				<div className="mt-1 md:mt-2.5 my-auto flex relative">
					<button
						...
						<GiHamburgerMenu className="p-1 md:p-1.5 ml-2 w-7 h-7 md:w-10 md:h-10 bi-list text-sm md:text-xl text-[#ff1717] font-bold rounded-sm" />
					</button>
			...
			<div
				className="id:outlet min-h-screen bg-gray-50 text-slate-800 dark:text-white "
				onClick={() => {
